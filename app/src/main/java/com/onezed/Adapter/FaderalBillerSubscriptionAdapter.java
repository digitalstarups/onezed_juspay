...
public class FaderalBillerSubscriptionAdapter extends ArrayAdapter<CustomerParameterBiller> implements Filterable {
    ...
    public FaderalBillerSubscriptionAdapter(@NonNull Context context, int resorce, @NonNull List<CustomerParameterBiller> billers,
                                            OnBillerClickListener listener) {
