...
public class BroadbandBillerAdapter extends ArrayAdapter<Biller> implements Filterable {
    private List<Biller> originalBillerList;
    private List<Biller> filteredBillerList;
    private BillerFilter billerFilter;

    public BroadbandBillerAdapter(@NonNull Context context, @NonNull List<Biller> billers) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Glide.with(getContext())
                ...
                .placeholder(R.drawable.ic_baseline_router)  // Optional: placeholder while loading
                .error(R.drawable.ic_baseline_router)  // Optional: error image if loading fails
                .into(image);
    ...
    private class BillerFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            List<Biller> filteredList = new ArrayList<>();
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (Biller biller : originalBillerList) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            filteredBillerList.addAll((List<Biller>) results.values);
