...
public class GasProviderAdapter extends ArrayAdapter<GasProviderModel> implements Filterable {
    private List<GasProviderModel> originalBillerList;
    private List<GasProviderModel> filteredBillerList;
    private GasProviderAdapter.BillerFilter billerFilter;

    public GasProviderAdapter(@NonNull Context context, @NonNull List<GasProviderModel> billers) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        GasProviderModel biller = getItem(position);
    ...
    @Nullable
    @Override
    public GasProviderModel getItem(int position) {
    ...
    public Filter getFilter() {
        if (billerFilter == null) {
            billerFilter = new GasProviderAdapter.BillerFilter();
        }
        return billerFilter;
    }
    ...
    private class BillerFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            List<GasProviderModel> filteredList = new ArrayList<>();
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (GasProviderModel biller : originalBillerList) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            filteredBillerList.addAll((List<GasProviderModel>) results.values);
